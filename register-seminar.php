                ...
                <form class="contact-form row" method="post" action="#" role="form">
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            <textarea class="form-control light-300" rows="8" placeholder="Description" id="floatingtextarea"></textarea>
                            <label for="floatingtextarea light-300">Description</label>
                        </div>
                    </div><!-- End Textarea Message -->

                    <div class="col-md-12 col-12 m-auto text-end">
                        <button type="submit" class="btn btn-secondary rounded-pill px-md-5 px-4 py-2 radius-0 text-light light-300">Register New Seminar</button>
                    </div>
