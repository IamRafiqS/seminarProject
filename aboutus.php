...
<head>
    <title>Insurance Seminar Project - About Us </title>
    <meta charset="utf-8">
        ...
        <div class="container my-4">
            <div class="row">
                ...
                <div class="banner-content col-lg-7 align-self-end">
                    <h2 class="h2 pb-3">Who are we?</h2>
        ...
        <div class="container my-4">
            <div class="row text-center">
                ...
                <div class="objective col-lg-4">
                    ...
                    <p class="light-300">
                        Trying to educate people about the hidden details in insurance policies and 
                        let insurance company be more clear with their insurance policies.
                    </p>
                </div>
                ...
                <div class="objective col-lg-4 mt-sm-0 mt-4">
                    ...
                    <p class="light-300">
                        Making sure all our clients fully understood their insurance policies including the hidden details 
                        that insurance agents would not tell.
                    </p>
                </div>
                ...
                <div class="objective col-lg-4 mt-sm-0 mt-4">
                    ...
                    <p class="light-300">
                        To help uncover the hidden details of your insurance policies.
                    </p>
                </div>
