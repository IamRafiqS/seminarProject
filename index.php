...
<head>
    <title>Insurance Seminar Project</title>
    <meta charset="utf-8">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1 class="banner-heading h1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-300 typo-space-line">
                                    Develop <strong>Knowledge</strong> About 
                                  <br>Your Insurance Policy
                              </h1>
                                <p class="banner-body text-muted py-3 mx-0 px-0">
                                    Upload your insurance policy here and we will tell you what your insurance agent did not tell you. You will know if you have overpaid your insurance, and you may cash out what you have paid for the last few years without compromising the protection on your current policy.
                              </p>
                                <a class="banner-button btn rounded-pill btn-outline-primary btn-lg px-4" href="options.php" role="button">Get Started</a>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1 class="banner-heading h1 text-secondary display-3 mb-0 pb-3 mx-0 px-0 light-300 typo-space-line">
                                    <strong>Expert</strong> Agents Ready <br>To Assist You
                                </h1><br>
                                <p class="banner-body text-muted py-3 mx-0 px-0">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="py-5 row d-flex align-items-center">
                            <div class="banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5">
                                <h1 class="banner-heading h1 text-secondary display-3 mb-0 pb-3 mx-0 px-0 light-300 typo-space-line">
                                    Learn The Truth About Your Insurance Policy From Our Seminars
                                </h1><br>
                                <p class="banner-body text-muted py-3 mx-0 px-0">
                                    Join our FREE seminar and let the experts tell you the <strong>truth</strong> about your insurance policy.
                                </p>
                                <a class="banner-button btn rounded-pill btn-outline-primary btn-lg px-4" href="options.php" role="button">Get Started</a>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row py-4">
                ...
                <div class="col-lg-3 col-md-4 my-sm-0 mt-4">
                    ...
                    <ul class="list-unstyled text-light light-300">
                        <li class="pb-2">
                            <i class='bx-fw bx bx-phone bx-xs'></i><a class="text-decoration-none text-light py-1">010-020-0340</a>
                        </li>
                        <li class="pb-2">
                            <i class='bx-fw bx bx-mail-send bx-xs'></i><a class="text-decoration-none text-light py-1">contactus@email.com</a>
                        </li>
                    </ul>
                </div>
