<?php
        ...
        $sql_member = "SELECT * from participant ORDER BY id ASC;";
...
<head>
    <title>I Agency Seminar - Participants List Page</title>
    <meta charset="utf-8">
        ...
        <div class="container py-4">
            <div class="row align-items-center justify-content-between">
                <div class="contact-header col-lg-4">
                    <h1 class="h2 pb-3 text-primary">Participants List</h1>
                    <!-- <h3 class="h4 regular-400">Elit, sed do eiusmod tempor</h3> -->
                    <p class="light-300">
                        This page is for admin to view and delete participants.
                    </p>
                </div>
        ...
        <div class="container-table100">
			...
			$success=true; 
				...
				<td class="column100 column2" data-column="column1">
                                ...
                                <td class="column100 column2" data-column="column1">
                                    <a href="participants-list.php?delete=<?php echo $row["id"]; ?>">
                                        Delete
                                </td></a>
                            </tr>
			<?php if($success){ ?>
   			<script> alert ("Participant Details Deleted!")</script>
 			<?php } ?>			
			<?php
                        }
                     	?>
